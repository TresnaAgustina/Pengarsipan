                    ...
                    <div class="table-responsive">
                        <table class="table">
                              ...
                              @foreach ($bsi as $item)
                                    ...
                                    <td>{{ $item->lokasi }}</td>
                                    <td>{{ $item->penyedia }}</td>
                                    <td><a href="{{ url('/editBsi/'.$item->id) }}" class="link_action edit">Edit</a></td>
                                    <td><a href="{{ url('/deleteBsi/'.$item->id) }}" class="link_action delete" onclick="return confirm('Are you sure you want to delete this?')">Delete</a></td>
                                    </tr>
                              @endforeach
                              </tbody>
                        </table>
